...
Release 1.2.0 final local and focused native acceptance, the host-path startup regression, cleanup and validation limits are recorded in [CONTINUATION.md](CONTINUATION.md).
